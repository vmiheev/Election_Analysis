...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        votes_by_county_percent = float(votes_by_county) / float(total_votes) * 100

         # 6d: Print the county results to the terminal.
        county_results = (
            f"{county}: {votes_by_county_percent:.1f}% ({votes_by_county:,})\n")
        ...
        if votes_by_county > largest_votes:
             largest_votes = votes_by_county
